...
<!-- Autogenerated file.  Do not edit. --><!-- Generated using 'focheck' version 0.7.2 --><!--
...
--><pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:axf="http://www.antennahouse.com/names/XSL/Extensions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" id="fo-property">
   ...
   <rule context="fo:*/@color">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('Color', 'EnumerationToken', 'EMPTY', 'ERROR', 'Object')">color=&quot;<value-of select="."/>&quot; should be Color, 'transparent', or 'inherit'. <value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
