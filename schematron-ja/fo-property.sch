...
<!-- Autogenerated file.  Do not edit. --><!-- Generated using 'focheck' version 0.7.10 --><!--
...
--><pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:axf="http://www.antennahouse.com/names/XSL/Extensions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" id="fo-property">
   ...
   <rule context="fo:*/@break-after">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'column', 'page', 'even-page', 'odd-page', 'inherit'))">break-after=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、column、page、even-page、odd-page 又は inheritです。トークン は <value-of select="$expression/@token"/> です。</report>
   ...
   <rule context="fo:*/@break-before">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'column', 'page', 'even-page', 'odd-page', 'inherit'))">break-before=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、column、page、even-page、odd-page 又は inheritです。トークン は <value-of select="$expression/@token"/> です。</report>
   ...
   <rule context="fo:*/@hyphenate">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('false', 'true', 'inherit'))">hyphenate=&quot;<value-of select="."/>&quot; です。許可されたキーワードは false、true 又は inherit でなければなりません。トークン は <value-of select="$expression/@token"/> です。</report>
   ...
   <rule context="fo:*/@page-position">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('only', 'first', 'last', 'rest', 'any', 'inherit'))">page-position=&quot;<value-of select="."/>&quot; です。許可されたキーワードは only、first、last、rest、any 又は inherit です。トークン は <value-of select="$expression/@token"/> です。</report>
   ...
   <rule context="fo:*/@text-transform">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('capitalize', 'uppercase', 'lowercase', 'none', 'inherit'))">text-transform=&quot;<value-of select="."/>&quot; です。許可されたキーワードは capitalize、uppercase、lowercase、none 又は inherit です。トークン は <value-of select="$expression/@token"/> です。</report>
