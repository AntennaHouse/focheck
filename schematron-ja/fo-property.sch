...
<!-- Autogenerated file.  Do not edit. --><!-- Generated using 'focheck' version 0.7.4 --><!--
...
--><pattern xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:axf="http://www.antennahouse.com/names/XSL/Extensions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" id="fo-property">
   ...
   <rule context="fo:*/@absolute-position">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'absolute', 'fixed', 'inherit'))">absolute-position=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、absolute、fixed又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： absolute-position=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@active-state">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('link', 'visited', 'active', 'hover', 'focus'))">active-state=&quot;<value-of select="."/>&quot; です。許可されたキーワードは link、visited、active、hover 又は focus です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">active-state=&quot;&quot; は link、visited、active、hover 又は focus でなければなりません。&lt;</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： active-state=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@alignment-adjust">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： alignment-adjust=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@alignment-baseline">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'baseline', 'before-edge', 'text-before-edge', 'middle', 'central', 'after-edge', 'text-after-edge', 'ideographic', 'alphabetic', 'hanging', 'mathematical', 'inherit'))">alignment-baseline=&quot;<value-of select="."/>&quot;です。許可されたキーワードは auto、baseline、before-edge、text-before-edge、middle、central、after-edge、text-after-edge、ideographic、alphabetic、hanging、mathematical 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： alignment-baseline=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@auto-restore">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false'))">auto-restore=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true 又は false です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">auto-restore=&quot;&quot; は true 又は false でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー：: auto-restore=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@background-attachment">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('scroll', 'fixed', 'inherit'))">background-attachment=&quot;<value-of select="."/>&quot; です。許可されたキーワードは scroll、fixed 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">background-attachment=&quot;&quot; は scroll、fixed 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： background-attachment=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@background-color">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('Color', 'EnumerationToken', 'EMPTY', 'ERROR', 'Object')">background-color=&quot;<value-of select="."/>&quot; は Color、transparent 又は inherit でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('transparent', 'inherit'))">background-color=&quot;<value-of select="."/>&quot; です。許可されたキーワードは transparent 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">background-color=&quot;&quot; は Color、transparent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： background-color=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@background-position-horizontal">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('left', 'center', 'right', 'inherit'))">background-position-horizontal=&quot;<value-of select="."/>&quot; です。許可されたキーワードは left、center、right 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： background-position-horizontal=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@background-position-vertical">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('top', 'center', 'bottom', 'inherit'))">background-position-vertical=&quot;<value-of select="."/>&quot; です。許可されたキーワードは top、center、bottom 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： background-position-vertical=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@background-repeat">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'EMPTY', 'ERROR', 'Object')">background-repeat=&quot;<value-of select="."/>&quot; はrepeat、repeat-x、repeat-y、no-repeat 又は paginate でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('repeat', 'repeat-x', 'repeat-y', 'no-repeat', 'paginate'))">background-repeat=&quot;<value-of select="."/>&quot; です。許可されたキーワードは repeat、repeat-x、repeat-y、no-repeat 又は paginateです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">background-repeat=&quot;&quot; は repeat、repeat-x、repeat-y、no-repeat 又は paginateでなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： background-repeat=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@baseline-shift">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('baseline', 'sub', 'super', 'inherit'))">baseline-shift=&quot;<value-of select="."/>&quot; です。許可されたキーワードは baseline、sub、super 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： baseline-shift=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@blank-or-not-blank">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('blank', 'not-blank', 'any', 'inherit'))">blank-or-not-blank=&quot;<value-of select="."/>&quot; です。許可されたキーワードは blank、not-blank、any 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： blank-or-not-blank=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@block-progression-dimension">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">block-progression-dimension=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： block-progression-dimension=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@border-after-precedence">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('force', 'inherit'))">border-after-precedence=&quot;<value-of select="."/>&quot; です。許可されたキーワードは force 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">border-after-precedence=&quot;&quot; は force、inherit 又は Number でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： border-after-precedence=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@border-before-precedence">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('force', 'inherit'))">border-before-precedence=&quot;<value-of select="."/>&quot; です。許可されたキーワードは force 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： border-before-precedence=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@border-collapse">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('collapse', 'collapse-with-precedence', 'separate', 'inherit'))">border-collapse=&quot;<value-of select="."/>&quot; です。許可されたキーワードは collapse、collapse-with-precedence、separate 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： border-collapse=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@border-end-precedence">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('force', 'inherit'))">border-end-precedence=&quot;<value-of select="."/>&quot; です。許可されたキーワードは force 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">border-end-precedence=&quot;&quot; は force、inherit 又は Number でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： border-end-precedence=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@border-separation">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">border-separation=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">border-separation=&quot;&quot; は Length 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： border-separation=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@border-start-precedence">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('force', 'inherit'))">border-start-precedence=&quot;<value-of select="."/>&quot; です。許可されたキーワードは force 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">border-start-precedence=&quot;&quot; は force 、 inherit 又は Number でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： border-start-precedence=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@bottom">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">bottom=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">bottom=&quot;&quot; は Length、Percent、auto 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： bottom=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@break-after">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'column', 'page', 'even-page', 'odd-page', 'inherit'))">break-after=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、column、page、even-page、odd-page 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： break-after=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@break-before">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'column', 'page', 'even-page', 'odd-page', 'inherit'))">break-before=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、column、page、even-page、odd-page 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： break-before=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@caption-side">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('before', 'after', 'start', 'end', 'top', 'bottom', 'left', 'right', 'inherit'))">caption-side=&quot;<value-of select="."/>&quot; です。許可されたキーワードは before、after、start、end、top、bottom、left、right 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： caption-side=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@case-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： case-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@case-title">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： case-title=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@change-bar-class">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： change-bar-class=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@change-bar-color">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('Color', 'EMPTY', 'ERROR', 'Object')">change-bar-color=&quot;<value-of select="."/>&quot; は Colorでなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">change-bar-color=&quot;&quot; は Colorでなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： change-bar-color=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@change-bar-offset">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： change-bar-offset=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@change-bar-placement">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('start', 'end', 'left', 'right', 'inside', 'outside', 'alternate'))">change-bar-placement=&quot;<value-of select="."/>&quot; です。許可されたキーワードは start、end、left、right、inside、outside 又は alternate です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： change-bar-placement=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@change-bar-style">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('none', 'hidden', 'dotted', 'dashed', 'solid', 'double', 'groove', 'ridge', 'inset', 'outset'))">change-bar-style=&quot;<value-of select="."/>&quot; です。許可されたキーワードは none、hidden、dotted、dashed、solid、double、groove、ridge、inset 又は outset です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： change-bar-style=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@change-bar-width">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('thin', 'medium', 'thick'))">change-bar-width=&quot;<value-of select="."/>&quot; です。許可されたキーワードは thin、medium 又は thick です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">change-bar-width=&quot;&quot; は thin、medium、thick 又は Length でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： change-bar-width=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@clear">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('start', 'end', 'left', 'right', 'inside', 'outside', 'both', 'none', 'inherit'))">clear=&quot;<value-of select="."/>&quot; です。許可されたキーワードは start、end、left、right、inside、outside、both、none 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： clear=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@clip">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">clip=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">clip=&quot;&quot; は Function、auto 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： clip=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@color">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('Color', 'EnumerationToken', 'EMPTY', 'ERROR', 'Object')">color=&quot;<value-of select="."/>&quot; は Color、 transparent 又は inherit でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('transparent', 'inherit'))">color=&quot;<value-of select="."/>&quot; です。許可されたキーワードは transparent 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">color=&quot;&quot; は Color、transparent 又は inherit です。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： color=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@color-profile-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： color-profile-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@column-count">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">column-count=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">column-count=&quot;&quot; は Number 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： column-count=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@column-gap">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">column-gap=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">column-gap=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： column-gap=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@column-number">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： column-number=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@column-width">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： column-width=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@content-height">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'scale-to-fit', 'scale-down-to-fit', 'scale-up-to-fit', 'inherit'))">content-height=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、scale-to-fit、scale-down-to-fit、scale-up-to-fit 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： content-height=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@content-width">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'scale-to-fit', 'scale-down-to-fit', 'scale-up-to-fit', 'inherit'))">content-width=&quot;<value-of select="."/>&quot;.です。許可されたキーワードは auto、scale-to-fit、scale-down-to-fit、scale-up-to-fit 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： content-width=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@destination-placement-offset">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： destination-placement-offset=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@direction">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('ltr', 'rtl', 'inherit'))">direction=&quot;<value-of select="."/>&quot; です。許可されたキーワードは ltr、rtl 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">direction=&quot;&quot; は ltr 、 rtl 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： direction=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@display-align">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'EMPTY', 'ERROR', 'Object')">display-align=&quot;<value-of select="."/>&quot; は auto、before、center、after 又は justify でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'before', 'center', 'after', 'justify'))">display-align=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、before、center、after 又は justify です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">display-align=&quot;&quot; は auto、before、center、after 又は justifyでなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： display-align=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@dominant-baseline">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'use-script', 'no-change', 'reset-size', 'ideographic', 'alphabetic', 'hanging', 'mathematical', 'central', 'middle', 'text-after-edge', 'text-before-edge', 'inherit'))">dominant-baseline=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、use-script、no-change、reset-size、ideographic、alphabetic、hanging、mathematical、central、middle、text-after-edge、text-before-edge 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： dominant-baseline=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@empty-cells">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('show', 'hide', 'inherit'))">empty-cells=&quot;<value-of select="."/>&quot; です。許可されたキーワードは show、hide 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">empty-cells=&quot;&quot; は show、hide 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： empty-cells=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@end-indent">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">end-indent=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">end-indent=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： end-indent=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@ends-row">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false'))">ends-row=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true 又は false です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">ends-row=&quot;&quot; は true 又は false でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： ends-row=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@extent">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">extent=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">extent=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： extent=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@float">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('before', 'start', 'end', 'left', 'right', 'inside', 'outside', 'none', 'inherit'))">float=&quot;<value-of select="."/>&quot; です。許可されたキーワードは before、start、end、left、right、inside、outside、none 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： float=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@flow-map-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： flow-map-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@flow-map-reference">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： flow-map-reference=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@flow-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： flow-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@flow-name-reference">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： flow-name-reference=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@font-selection-strategy">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'character-by-character', 'inherit'))">font-selection-strategy=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、character-by-character 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： font-selection-strategy=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@font-size">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('xx-small', 'x-small', 'small', 'medium', 'large', 'x-large', 'xx-large', 'larger', 'smaller', 'inherit'))">font-size=&quot;<value-of select="."/>&quot; です。許可されたキーワードは xx-small、x-small、small、medium、large、x-large、xx-large、larger、smaller又はinherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： font-size=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@font-size-adjust">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('none', 'inherit'))">font-size-adjust=&quot;<value-of select="."/>&quot; です。許可されたキーワードは none 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">font-size-adjust=&quot;&quot; は Number、 none 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： font-size-adjust=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@font-stretch">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('normal', 'wider', 'narrower', 'ultra-condensed', 'extra-condensed', 'condensed', 'semi-condensed', 'semi-expanded', 'expanded', 'extra-expanded', 'ultra-expanded', 'inherit'))">font-stretch=&quot;<value-of select="."/>&quot; です。許可されたキーワードは normal、wider、narrower、ultra-condensed、extra-condensed、condensed、semi-condensed、semi-expanded、expanded、extra-expanded、ultra-expanded又はinherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： font-stretch=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@font-style">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('normal', 'italic', 'oblique', 'backslant', 'inherit'))">font-style=&quot;<value-of select="."/>&quot; です。許可されたキーワードは normal、italic、oblique、backslant 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： font-style=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@font-variant">
      <report test=". eq ''" role="Warning">font-variant=&quot;&quot; は normal | small-caps | inherit でなければなりません。</report>
   </rule>
   ...
   <rule context="fo:*/@font-weight">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('normal', 'bold', 'bolder', 'lighter', 'inherit'))">font-weight=&quot;<value-of select="."/>&quot; です。許可されたキーワードは normal、bold、bolder、lighter又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： font-weight=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@glyph-orientation-horizontal">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">glyph-orientation-horizontal=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">glyph-orientation-horizontal=&quot;&quot; は Literal 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： glyph-orientation-horizontal=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@glyph-orientation-vertical">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">glyph-orientation-vertical=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： glyph-orientation-vertical=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@grouping-size">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： grouping-size=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@height">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">height=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">height=&quot;&quot; は Length、Percent、auto 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： height=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@hyphenate">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('false', 'true', 'inherit'))">hyphenate=&quot;<value-of select="."/>&quot; です。許可されたキーワードは false、true 又は inherit でなければなりません。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">hyphenate=&quot;&quot; は false、true 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： hyphenate=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@hyphenation-keep">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'column', 'page', 'inherit'))">hyphenation-keep=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、column、page 又は inherit でなければなりません。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">hyphenation-keep=&quot;&quot; は auto、column、page 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： hyphenation-keep=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@hyphenation-ladder-count">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('no-limit', 'inherit'))">hyphenation-ladder-count=&quot;<value-of select="."/>&quot; です。許可されたキーワードは no-limit 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： hyphenation-ladder-count=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@hyphenation-push-character-count">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">hyphenation-push-character-count=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： hyphenation-push-character-count=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@hyphenation-remain-character-count">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">hyphenation-remain-character-count=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： hyphenation-remain-character-count=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@index-class">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： index-class=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@indicate-destination">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false'))">indicate-destination=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true 又は false です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">indicate-destination=&quot;&quot; は true 又は false でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： indicate-destination=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@initial-page-number">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'auto-odd', 'auto-even', 'inherit'))">initial-page-number=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、auto-odd、auto-even、又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： initial-page-number=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@inline-progression-dimension">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">inline-progression-dimension=&quot;<value-of select="."/>&quot;です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： inline-progression-dimension=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@intrinsic-scale-value">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">intrinsic-scale-value=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">intrinsic-scale-value=&quot;&quot; は Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： intrinsic-scale-value=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@intrusion-displace">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'none', 'line', 'indent', 'block', 'inherit'))">intrusion-displace=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、none、line、indent、block 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： intrusion-displace=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@keep-together">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'always', 'inherit'))">keep-together=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、always 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">keep-together=&quot;&quot; は auto、always、inherit 又は Number でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： keep-together=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@keep-with-next">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'always', 'inherit'))">keep-with-next=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、always 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">keep-with-next=&quot;&quot; は auto、always、inherit 又は Number でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： keep-with-next=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@keep-with-previous">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'always', 'inherit'))">keep-with-previous=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、always 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： keep-with-previous=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@last-line-end-indent">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">last-line-end-indent=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">last-line-end-indent=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： last-line-end-indent=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@leader-alignment">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'EMPTY', 'ERROR', 'Object')">leader-alignment=&quot;<value-of select="."/>&quot; は none、reference-area、page、start、center 又は endでなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('none', 'reference-area', 'page', 'start', 'center', 'end'))">leader-alignment=&quot;<value-of select="."/>&quot; です。許可されたキーワードは none、reference-area、page、start、center 又は endです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">leader-alignment=&quot;&quot; は none、reference-area、page、start、center 又は endでなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： leader-alignment=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@leader-length">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">leader-length=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">leader-length=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： leader-length=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@leader-pattern">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('space', 'rule', 'dots', 'use-content', 'inherit'))">leader-pattern=&quot;<value-of select="."/>&quot; です。許可されたキーワードは space、rule、dots、use-content 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： leader-pattern=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@leader-pattern-width">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('use-font-metrics', 'inherit'))">leader-pattern-width=&quot;<value-of select="."/>&quot; です。許可されたキーワードは use-font-metrics 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： leader-pattern-width=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@left">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">left=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">left=&quot;&quot; は Length、Percent、auto 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： left=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@letter-spacing">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('normal', 'inherit'))">letter-spacing=&quot;<value-of select="."/>&quot; です。許可されたキーワードは normal 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">letter-spacing=&quot;&quot; は normal、inherit 又は Length でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： letter-spacing=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@letter-value">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'alphabetic', 'traditional'))">letter-value=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、alphabetic 又は traditional です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">letter-value=&quot;&quot; は auto、alphabetic 又は traditional でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： letter-value=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@line-height">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('normal', 'inherit'))">line-height=&quot;<value-of select="."/>&quot; です。許可されたキーワードは normal 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： line-height=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@line-height-shift-adjustment">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('consider-shifts', 'disregard-shifts', 'inherit'))">line-height-shift-adjustment=&quot;<value-of select="."/>&quot; です。許可されたキーワードは consider-shifts、disregard-shifts 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： line-height-shift-adjustment=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@line-stacking-strategy">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('line-height', 'font-height', 'max-height', 'inherit'))">line-stacking-strategy=&quot;<value-of select="."/>&quot; です。許可されたキーワードは line-height、font-height、max-height 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： line-stacking-strategy=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@linefeed-treatment">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： linefeed-treatment=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@margin-bottom">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">margin-bottom=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">margin-bottom=&quot;&quot; は auto、inherit、Length 又は Percent でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： margin-bottom=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@margin-left">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">margin-left=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">margin-left=&quot;&quot; は auto、inherit、Length 又は Percent でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： margin-left=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@margin-right">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">margin-right=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">margin-right=&quot;&quot; は auto、inherit、Length 又は Percent でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： margin-right=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@margin-top">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">margin-top=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">margin-top=&quot;&quot; は auto、inherit、Length 又は Percent でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： margin-top=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@marker-class-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： marker-class-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@master-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： master-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@master-reference">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： master-reference=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@maximum-repeats">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('no-limit', 'inherit'))">maximum-repeats=&quot;<value-of select="."/>&quot; です。許可されたキーワードは no-limit 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">maximum-repeats=&quot;&quot; は Number、no-limit 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： maximum-repeats=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@media-usage">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'paginate', 'bounded-in-one-dimension', 'unbounded'))">media-usage=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、paginate、bounded-in-one-dimension 又は unbounded です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： media-usage=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@merge-pages-across-index-key-references">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('merge', 'leave-separate'))">merge-pages-across-index-key-references=&quot;<value-of select="."/>&quot; です。許可されたキーワードは merge 又は leave-separate です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： merge-pages-across-index-key-references=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@merge-ranges-across-index-key-references">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('merge', 'leave-separate'))">merge-ranges-across-index-key-references=&quot;<value-of select="."/>&quot; です。許可されたキーワードは merge 又は leave-separate です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： merge-ranges-across-index-key-references=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@merge-sequential-page-numbers">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('merge', 'leave-separate'))">merge-sequential-page-numbers=&quot;<value-of select="."/>&quot; です。許可されたキーワードは merge 又は leave-separate です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： merge-sequential-page-numbers=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@number-columns-repeated">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： number-columns-repeated=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@number-columns-spanned">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： number-columns-spanned=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@number-rows-spanned">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： number-rows-spanned=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@odd-or-even">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'EMPTY', 'ERROR', 'Object')">odd-or-even=&quot;<value-of select="."/>&quot; は odd、even、odd-document、even-document 又は anyでなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('odd', 'even', 'odd-document', 'even-document', 'any'))">odd-or-even=&quot;<value-of select="."/>&quot; です。許可されたキーワードは odd、even、odd-document、even-document 又は anyです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">odd-or-even=&quot;&quot; odd、even、odd-document、even-document 又は anyでなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： odd-or-even=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@orphans">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">orphans=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">orphans=&quot;&quot; は Number 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： orphans=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@overflow">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('visible', 'hidden', 'scroll', 'error-if-overflow', 'repeat', 'replace', 'condense', 'auto'))">overflow=&quot;<value-of select="."/>&quot; です。許可されたキーワードは visible、hidden、scroll、error-if-overflow、repeat、replace、condense 又は auto です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： overflow=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-after">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-after=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-after=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-after=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-before">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-before=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-before=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-before=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-bottom">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-bottom=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-bottom=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-bottom=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-end">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-end=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-end=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-end=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-left">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-left=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-left=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-left=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-right">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-right=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-right=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-right=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-start">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-start=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-start=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-start=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@padding-top">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">padding-top=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">padding-top=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： padding-top=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@page-citation-strategy">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('all', 'normal', 'non-blank', 'inherit'))">page-citation-strategy=&quot;<value-of select="."/>&quot; です。許可されたキーワードは all、normal、non-blank 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： page-citation-strategy=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@page-height">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'indefinite', 'inherit'))">page-height=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、indefinite又はinheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">page-height=&quot;&quot; は auto、indefinite、inherit 又は Length でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： page-height=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@page-number-treatment">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('link', 'no-link'))">page-number-treatment=&quot;<value-of select="."/>&quot; です。許可されたキーワードは link 又は no-link です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">page-number-treatment=&quot;&quot; は link 又は no-link でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： page-number-treatment=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@page-position">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('only', 'first', 'last', 'rest', 'any', 'inherit'))">page-position=&quot;<value-of select="."/>&quot; です。許可されたキーワードは only、first、last、rest、any 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： page-position=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@page-width">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'indefinite', 'inherit'))">page-width=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、indefinite又はinheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">page-width=&quot;&quot; は auto、indefinite、inherit 又は Length でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： page-width=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@precedence">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false', 'inherit'))">precedence=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true、false 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">precedence=&quot;&quot; は true、false 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： precedence=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@provisional-distance-between-starts">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">provisional-distance-between-starts=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： provisional-distance-between-starts=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@provisional-label-separation">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">provisional-label-separation=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： provisional-label-separation=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@region-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： region-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@region-name-reference">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： region-name-reference=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@relative-align">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('before', 'baseline', 'inherit'))">relative-align=&quot;<value-of select="."/>&quot; です。許可されたキーワードは before、baseline 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">relative-align=&quot;&quot; は before、baseline 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： relative-align=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@relative-position">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('static', 'relative', 'inherit'))">relative-position=&quot;<value-of select="."/>&quot; です。許可されたキーワードは static、relative 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">relative-position=&quot;&quot; は static、relative 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： relative-position=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@rendering-intent">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'perceptual', 'relative-colorimetric', 'saturation', 'absolute-colorimetric', 'inherit'))">rendering-intent=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、perceptual、relative-colorimetric、saturation、absolute-colorimetric 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： rendering-intent=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@retrieve-boundary">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('page', 'page-sequence', 'document'))">retrieve-boundary=&quot;<value-of select="."/>&quot; です。許可されたキーワードは page、page-sequence 又は document です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： retrieve-boundary=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@retrieve-boundary-within-table">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('table', 'table-fragment', 'page'))">retrieve-boundary-within-table=&quot;<value-of select="."/>&quot; です。許可されたキーワードは table、table-fragment 又は page です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： retrieve-boundary-within-table=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@retrieve-class-name">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： retrieve-class-name=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@retrieve-position">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('first-starting-within-page', 'first-including-carryover', 'last-starting-within-page', 'last-ending-within-page'))">retrieve-position=&quot;<value-of select="."/>&quot; です。許可されたキーワードは first-starting-within-page、first-including-carryover、last-starting-within-page 又は last-ending-within-page です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： retrieve-position=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@retrieve-position-within-table">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('first-starting', 'first-including-carryover', 'last-starting', 'last-ending'))">retrieve-position-within-table=&quot;<value-of select="."/>&quot; です。許可されたキーワードは first-starting、first-including-carryover、last-starting 又は last-ending です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： retrieve-position-within-table=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@right">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">right=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">right=&quot;&quot; は Length、Percent、auto 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： right=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@rule-style">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('none', 'dotted', 'dashed', 'solid', 'double', 'groove', 'ridge', 'inherit'))">rule-style=&quot;<value-of select="."/>&quot; です。許可されたキーワードは none、dotted、dashed、solid、double、groove、ridge 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： rule-style=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@rule-thickness">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： rule-thickness=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@scale-option">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('width', 'height', 'inherit'))">scale-option=&quot;<value-of select="."/>&quot; です。許可されたキーワードは width、height 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">scale-option=&quot;&quot; は width、height 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： scale-option=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@scaling">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('uniform', 'non-uniform', 'inherit'))">scaling=&quot;<value-of select="."/>&quot; です。許可されたキーワードは uniform、non-uniform 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">scaling=&quot;&quot; は uniform、non-uniform 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： scaling=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@scaling-method">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'integer-pixels', 'resample-any-method', 'inherit'))">scaling-method=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、integer-pixels、resample-any-method 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： scaling-method=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@score-spaces">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false', 'inherit'))">score-spaces=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true、false 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">score-spaces=&quot;&quot; は true、false 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： score-spaces=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@script">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('none', 'auto', 'inherit'))">script=&quot;<value-of select="."/>&quot; です。許可されたキーワードは none、auto又はinheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">script=&quot;&quot; は none、auto、inherit 又は Literal でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： script=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@show-destination">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('replace', 'new'))">show-destination=&quot;<value-of select="."/>&quot; です。許可されたキーワードは replace 又は new です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">show-destination=&quot;&quot; は replace 又は new でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： show-destination=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@source-document">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： source-document=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@space-after">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">space-after=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">space-after=&quot;&quot; は Length 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： space-after=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@space-before">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">space-before=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">space-before=&quot;&quot; は Length 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： space-before=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@space-end">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">space-end=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">space-end=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： space-end=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@space-start">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">space-start=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">space-start=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： space-start=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@span">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('none', 'all', 'inherit'))">span=&quot;<value-of select="."/>&quot; です。許可されたキーワードは none、all 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">span=&quot;&quot; は none、all 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： span=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@start-indent">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">start-indent=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">start-indent=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： start-indent=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@starting-state">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('show', 'hide'))">starting-state=&quot;<value-of select="."/>&quot; です。許可されたキーワードは show 又は hide です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">starting-state=&quot;&quot; は show 又は hide でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： starting-state=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@starts-row">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false'))">starts-row=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true 又は false です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">starts-row=&quot;&quot; は true 又は false でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： starts-row=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@suppress-at-line-break">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'suppress', 'retain', 'inherit'))">suppress-at-line-break=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、suppress、retain 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： suppress-at-line-break=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@switch-to">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： switch-to=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@table-layout">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'fixed', 'inherit'))">table-layout=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、fixed 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">table-layout=&quot;&quot; は auto、fixed 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： table-layout=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@table-omit-footer-at-break">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false'))">table-omit-footer-at-break=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true 又は false です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">table-omit-footer-at-break=&quot;&quot; は true 又は false でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： table-omit-footer-at-break=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@table-omit-header-at-break">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('true', 'false'))">table-omit-header-at-break=&quot;<value-of select="."/>&quot; です。許可されたキーワードは true 又は false です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">table-omit-header-at-break=&quot;&quot; は true 又は false でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： table-omit-header-at-break=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@target-presentation-context">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'URI', 'EMPTY', 'ERROR', 'Object')">target-presentation-context=&quot;<value-of select="."/>&quot; は use-target-processing-context 又は ＵＲＩ でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">target-presentation-context=&quot;&quot; は use-target-processing-context 又は ＵＲＩ でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： target-presentation-context=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@target-processing-context">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'URI', 'EMPTY', 'ERROR', 'Object')">target-processing-context=&quot;<value-of select="."/>&quot; は document-root 又は ＵＲＩ でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">target-processing-context=&quot;&quot; は document-root 又は ＵＲＩ でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： target-processing-context=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@target-stylesheet">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'URI', 'EMPTY', 'ERROR', 'Object')">target-stylesheet=&quot;<value-of select="."/>&quot; は use-normal-stylesheet 又は ＵＲＩ でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">target-stylesheet=&quot;&quot; は use-normal-stylesheet 又は ＵＲＩ でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： target-stylesheet=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@text-align-last">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('relative', 'start', 'center', 'end', 'justify', 'inside', 'outside', 'left', 'right', 'inherit'))">text-align-last=&quot;<value-of select="."/>&quot; です。許可されたキーワードは relative、start、center、end、justify、inside、outside、left、right 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： text-align-last=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@text-altitude">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('use-font-metrics', 'inherit'))">text-altitude=&quot;<value-of select="."/>&quot; です。許可されたキーワードは use-font-metrics 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： text-altitude=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@text-decoration">
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： text-decoration=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@text-depth">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('use-font-metrics', 'inherit'))">text-depth=&quot;<value-of select="."/>&quot; です。許可されたキーワードは use-font-metrics 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： text-depth=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@text-indent">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">text-indent=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">text-indent=&quot;&quot; は Length、Percent 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： text-indent=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@text-shadow">
      <let name="expression" value="ahf:parser-runner(.)"></let>
      <assert test="local-name($expression) = ('EnumerationToken', 'Color', 'Length', 'EMPTY', 'ERROR', 'Object') or $expression/@value = '0'">text-shadow=&quot;<value-of select="."/>&quot; は none、inherit、 Color 又は Length でなければなりません。<value-of select="."/> は <value-of select="local-name($expression)"/> です。</assert>
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('none', 'inherit'))">text-shadow=&quot;<value-of select="."/>&quot; です。許可されたキーワードは none 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">text-shadow=&quot;&quot; は none、inherit、 Color 又は Length でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： text-shadow=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@text-transform">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('capitalize', 'uppercase', 'lowercase', 'none', 'inherit'))">text-transform=&quot;<value-of select="."/>&quot; です。許可されたキーワードは capitalize、uppercase、lowercase、none 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： text-transform=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@top">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">top=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">top=&quot;&quot; は Length、Percent、auto 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： top=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@treat-as-word-space">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'true', 'false', 'inherit'))">treat-as-word-space=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto、true、false 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">treat-as-word-space=&quot;&quot; は auto、true、false 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： treat-as-word-space=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@unicode-bidi">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('normal', 'embed', 'bidi-override', 'inherit'))">unicode-bidi=&quot;<value-of select="."/>&quot; です。許可されたキーワードは normal、embed、bidi-override 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： unicode-bidi=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@visibility">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('visible', 'hidden', 'collapse', 'inherit'))">visibility=&quot;<value-of select="."/>&quot; です。許可されたキーワードは visible、hidden、collapse 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">visibility=&quot;&quot; は visible、hidden、collapse 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： visibility=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@white-space-collapse">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('false', 'true', 'inherit'))">white-space-collapse=&quot;<value-of select="."/>&quot; です。許可されたキーワードは false、true 又は inherit でなければなりません。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">white-space-collapse=&quot;&quot; は false、true 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： white-space-collapse=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@white-space-treatment">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('ignore', 'preserve', 'ignore-if-before-linefeed', 'ignore-if-after-linefeed', 'ignore-if-surrounding-linefeed', 'inherit'))">white-space-treatment=&quot;<value-of select="."/>&quot; です。許可されたキーワードは ignore、preserve、ignore-if-before-linefeed、ignore-if-after-linefeed、ignore-if-surrounding-linefeed 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： white-space-treatment=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@widows">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('inherit'))">widows=&quot;<value-of select="."/>&quot; です。許可されたキーワードは inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">widows=&quot;&quot; は Number 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： widows=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@width">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">width=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">width=&quot;&quot; は Length、Percent、 auto 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： width=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@word-spacing">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('normal', 'inherit'))">word-spacing=&quot;<value-of select="."/>&quot; です。許可されたキーワードは normal 又は inheritです。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">word-spacing=&quot;&quot; は normal 、 inherit 又は Length でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： word-spacing=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@wrap-option">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('no-wrap', 'wrap', 'inherit'))">wrap-option=&quot;<value-of select="."/>&quot; です。許可されたキーワードは no-wrap、wrap 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">wrap-option=&quot;&quot; は no-wrap、wrap 又は inherit でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： wrap-option=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@writing-mode">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('lr-tb', 'rl-tb', 'tb-rl', 'tb-lr', 'bt-lr', 'bt-rl', 'lr-bt', 'rl-bt', 'lr-alternating-rl-bt', 'lr-alternating-rl-tb', 'lr-inverting-rl-bt', 'lr-inverting-rl-tb', 'tb-lr-in-lr-pairs', 'lr', 'rl', 'tb', 'inherit'))">writing-mode=&quot;<value-of select="."/>&quot; です。許可されたキーワードは lr-tb、rl-tb、tb-rl、tb-lr、bt-lr、bt-rl、lr-bt、rl-bt、lr-alternating-rl-bt、lr-alternating-rl-tb、lr-inverting-rl-bt、lr-inverting-rl-tb、tb-lr-in-lr-pairs、lr、rl、tb 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      ...
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： writing-mode=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
   ...
   <rule context="fo:*/@z-index">
      ...
      <report test="$expression instance of element(EnumerationToken) and not($expression/@token = ('auto', 'inherit'))">z-index=&quot;<value-of select="."/>&quot; です。許可されたキーワードは auto 又は inherit です。トークンは '<value-of select="$expression/@token"/>' です。</report>
      <report test="local-name($expression) = 'EMPTY'" role="Warning">z-index=&quot;&quot; は auto、inherit 又は Number でなければなりません。</report>
      <report test="local-name($expression) = 'ERROR'">シンタックスエラー： z-index=&quot;<value-of select="."/>&quot;::<value-of select="$expression"/>
      </report>
   </rule>
