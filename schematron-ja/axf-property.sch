...
--><pattern id="axf-property" xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- <color> | none -->
	<!-- Inherited: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.annotation-color -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#background-color -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.background-image -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: yes -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.background-position -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.background-repeat -->
	...
	<!-- Inherited: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.baseline-block-snap -->
	...
	<!-- <length> | <percentage> -->
	<!-- Inherited: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.column-rule-length -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.field-button-icon -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.field-button-icon-down -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.field-button-icon-rollover -->
	...
	<!-- Inherited: yes -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.image-orientation -->
	...
	<!-- Inherited: yes -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.initial-letters -->
	...
	<!-- Inherited: yes -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.line-number-background-color -->
	...
	<!-- Inherited: yes -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.line-number-color -->
	...
	<!-- Inherited: yes -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf:line-number-font-size -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.line-number-initial -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.line-number-interval -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.line-number-start -->
	...
	<!-- Inherited: yes -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.line-number-text-decoration -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.line-number-width -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.media-duration -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.media-play-mode -->
	...
	<!-- auto | <color> -->
	<!-- Inherited: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.media-skin-color -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.media-volume -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.media-window-height -->
	...
	<!-- <string> -->
	<!-- Inherited: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.page-number-prefix -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.poster-content -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.poster-image -->
	...
	<!-- <color> -->
	<!-- Inherited: yes -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.revision-bar-color -->
	...
	<!-- <length> -->
	<!-- Inherited: yes -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.revision-bar-offset -->
	...
	<!-- Inherited: yes -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.revision-bar-position -->
	...
	<!-- <border-style> -->
	<!-- Inherited: yes -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.revision-bar-style -->
	...
	<!-- <border-width> -->
	<!-- Inherited: yes -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.revision-bar-width -->
	...
	<!-- <string> -->
	<!-- Inherited: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.suppress-duplicate-page-number -->
	...
	<!-- Inherited: yes -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.text-justify -->
	...
	<!-- auto | <color> -->
	<!-- Inherited: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.text-line-color -->
	...
	<!-- Inherited: no -->
	<!-- Shorthand: no -->
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.text-line-width -->
   ...
   <rule context="fo:*/@color-profile-name">
	...
	<!-- https://www.antenna.co.jp/AHF/help/ja/ahf-ext.html#axf.overflow -->
